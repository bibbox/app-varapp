...
HOST = os.getenv('HOST', 'localhost')                  # Hostname, as returned by "hostname --fqdn" on unix.
BASE_URL = os.getenv('BASE_URL', 'http://localhost:8000')  # URL to serve the app to.
SECRET_KEY = os.getenv('SECRET_KEY', 'K6QKN6C2xtcl.')        # Used to generate authentication tokens. Change it and keep it secret!

## Email: SMTP server configuration
EMAIL_HOST = os.getenv('EMAIL_HOST', 'localhost')
EMAIL_PORT = os.getenv('EMAIL_PORT', 1025)
EMAIL_FROM = os.getenv('EMAIL_FROM', 'varapp@varapp.vital-it.ch')
...
MYSQL_PWD = os.getenv('MYSQL_PASSWORD', 'pwd')     # cf. docker-compose.yml
